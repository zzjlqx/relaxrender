...
from features.utah_teapot.scene import Scene
from features.utah_teapot.camera import PerspectiveCamera
from features.utah_teapot.mesh import Mesh
from features.utah_teapot.texture import Texture, PlaneLightSource, UniformReflection
...
from features.utah_teapot.color import Color, Red, White, Black, Green, Blue, Grey
