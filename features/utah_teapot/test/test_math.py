...
import numpy as np
from features.utah_teapot.example_meshs import *
from features.utah_teapot.math import *
from features.utah_teapot.points import *
from features.utah_teapot.triangle import *
